...
const AuthModal: React.FC<AuthModalProps> = ({ isOpen, onClose, initialView, onAuthSuccess }) => {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
      ...
      {/* Modal */}
      <div className="relative w-full max-w-md bg-surface-primary border border-white/10 rounded-3xl shadow-2xl overflow-hidden animate-scale-in">
        {/* Header */}
             ...
             <>
              <div className="space-y-1">
                ...
                <input 
                  ...
                  className="w-full bg-surface-secondary border border-white/10 rounded-xl px-4 py-3 text-white focus:outline-none focus:border-blue-500 transition-colors"
                  placeholder="John Doe"
                  required
                />
              </div>
              <div className="space-y-1">
                <label className="text-xs font-bold text-gray-500 uppercase tracking-wider ml-1">Tag (@handle)</label>
                <input 
                  type="text" 
        ...
        {/* Footer */}
        <div className="bg-surface-secondary/50 p-4 text-center border-t border-white/5">
